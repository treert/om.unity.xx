...
public class TestIMGUIMono : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(10, 40, 100, 20), "btn", m_style))
        {
        ...
        }
        {
            ...
            selectedToolbar = GUI.Toolbar(new Rect(300, 100, 300, 30), selectedToolbar, toolbarStrings);
